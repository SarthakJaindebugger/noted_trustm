...
def build_crm_form_payload(questionnaire: dict, metadata: dict) -> dict:
    ...
    return {
        ...
        "fieldWorkWhere": "",
        "heardFrom": map_answer(questionnaire.get("Heard from the guidance/advice position (if other where?)")) or "No information",
        ...
        "firstTimeVisitor": map_answer(questionnaire.get("Is this the customer's first visit?")) or "No information",
        "counsellingOwnLanguage": map_answer(questionnaire.get("Was the language of counselling the customer's own language?")) or "No information",
        "interpreterPresent": map_answer(questionnaire.get("External interpreter present or telephone?")) or "No",
        "interpretingLanguage": map_answer(questionnaire.get("Interpreting language")) or "",
        "contents": contents,
